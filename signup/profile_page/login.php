...
<div class="container">
	<div class="row">
     ...
     <div class="form-group"><center><h3>Login Form</h3></center>
...
if(isset($_GET['loginerror'])) {
 ...
 if(!empty($loginerror)){  echo '<p class="errmsg">Invalid login credentials, Please Try Again..</p>'; } ?>
    ...
    <input type="text" name="login_var" placeholder="Enter Your Username or Email" value="<?php if(!empty($loginerror)){ echo  $loginerror; } ?>" class="form-control" required="">
  </div>
  <div class="form-group">
    <label class="label_txt">Password: </label>
    <input type="password" name="password" class="form-control" id="myInput" placeholder="Enter Your Password" required="">
  </div>
  <div class="form-group">
    <label class="label_txt"></label>
    <input type="checkbox" onclick="show()">Show Password
  </div>
  <button type="submit" name="sublogin" class="btn btn btn-info btn">Login</button>
</form>
