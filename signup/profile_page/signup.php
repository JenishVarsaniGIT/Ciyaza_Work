...
$row = mysqli_fetch_assoc($res);
    ...
    $password = password_hash($password,PASSWORD_BCRYPT,$options);
            ...
            $result = mysqli_query($dbc,"INSERT into users1(username,email,password,date) values('$username','$email','$password','$date')");
...
?>
  ...
  <div class="form-group"><br><br><center><h3>Signup Form</h3></center>
  	
        <!-- <label class="label_txt">First Name: </label>
    <input type="text" class="form-control" name="fname" placeholder="Enter Your First name" value="<?php if(isset($error)){ echo $_POST['fname'];}?>" required="">
  </div>
  <div class="form-group">
    <label class="label_txt">Last Name: </label>
    <input type="text" class="form-control" name="lname" placeholder="Enter Your Last name" value="<?php if(isset($error)){ echo $_POST['lname'];}?>" required="">
  </div> -->
 
<div class="form-group">
    <label class="label_txt">Username: </label>
    <input type="text" class="form-control" name="username" placeholder="Enter Your username" value="<?php if(isset($error)){ echo $_POST['username'];}?>" required="">
  </div>

<div class="form-group">
    <label class="label_txt">Email: </label>
    <input type="email" class="form-control" name="email" placeholder="Enter Your First Email" value="<?php if(isset($error)){ echo $_POST['email'];}?>" required="">
  </div>
  <div class="form-group">
    <label class="label_txt">image: </label><br>
    <input type="file" class="form-controlr">
  </div>
  <div class="form-group">
    <label class="label_txt">Password: </label>
    <input type="password" name="password" id="myInput" class="form-control" placeholder="Enter Your Password" required="">
  </div>
  <div class="form-group">
   ...
   <div class="form-group">
    ...
    <input type="password" name="passwordConfirm" class="form-control" placeholder="Enter Your Confirm Password" required="">
  </div>
  <div class="form-group">
    <label for="label_txt">BirthDate: </label><br>
    <input type="date" name="bdate" class="from-control" required="">
  </div>
  <button type="submit" name="signup" class="btn btn btn-info btn">SignUp</button>
